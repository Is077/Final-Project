...
<html lang="en">
    ...
    <body>
        <div class="login-page">
          <img src="complogo.png" alt="Company Logo" id="logo">
          <p class="long-text"><b>Where Learning in Fun!</b></p>
           <div class="form">
              <form id="login-form" class="login-form" method="POST" target="">
                <div class="form-fill">
                  <p style="color: blue; font-size:12px;"><?php if(isset($errorss['validate_mail'])) echo $errorss['validate_mail']; ?></p>
                  <p style="color: blue; font-size:12px;"><?php if(isset($errorss['validate_pass'])) echo $errorss['validate_pass']; ?></p>
                  <p style="color: blue; font-size:12px;"><?php if(isset($errorss['validate'])) echo $errorss['validate']; ?></p>
